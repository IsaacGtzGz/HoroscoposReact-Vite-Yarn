...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      // --- MANIFIESTO FINAL CON ÍCONOS GENERADOS ---
      manifest: {
        name: 'Horóscopo Sabiduría Astral',
        short_name: 'Horoscopo',
        description: 'Consulta diaria de horóscopo con enfoque en paz y bienestar.',
        theme_color: '#fcfcfc', // Fondo principal de la app
        "icons": [
          {
